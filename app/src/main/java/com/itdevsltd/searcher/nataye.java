...
public class nataye extends AppCompatActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		this.setTitle("Andikisha ibyo wataye");
...
language=shared.getString("language","not found");
	...
	public void validate()
	{
		...
		{
			layout_doc.setError("Andika icyo wataye");
		...
		{
			layout_desc.setError("Andika Aho cyaheze");
			layout_sel.setError(null);
			layout_doc.setError(null);
...
//////////////////////////////////////////////////////////
	...
	private class send extends AsyncTask<String, String, String>
	{
		...
		protected void onPostExecute(String result) {
			...
			{
				Toast.makeText(getApplicationContext(),"Murakoze, nicyiboneka tuzabamenyesha!",Toast.LENGTH_LONG).show();
				sel.setText("");
				desc.setText("");
				doc.setText("");
			}
			...
			{
				Toast.makeText(getApplicationContext(),"Hari uwagitoye, dushobora kubahuza",Toast.LENGTH_LONG).show();
				sel.setText("");
				desc.setText("");
				doc.setText("");
				decoder(result);
	...
	public void decoder(String json)
	{
		...
		try
		{
			...
			new AlertDialog.Builder(nataye.this)
				...
				.setMessage("Hari umuntu wamenyekanishije ko yatoraguye "+tit+" nimero "+ser+"dushobora kubahuza mukumvikana")
...
if(language.equals("Kinyarwanda")){
	...
	Intent in=new Intent(nataye.this,com.itdevsltd.searcher.english.HomeActivity.class);
	in.putExtras(bundle);
	startActivity(in);
	nataye.this.overridePendingTransition(android.R.anim.slide_in_left,android.R.anim.slide_out_right);
