...
public String language;
	...
	public boolean validate()
	{
		...
		{
			layout_phone.setError("Nta jambobanga mwashyizemo!");
			layout_pass.setError(null);
	...
	private class log extends AsyncTask<String, String, String>
	{
		...
		protected void onPostExecute(String result) {
			...
			else
			{
				...
				Toast.makeText(getApplicationContext(),"Mwanditse telephone cg ijambobanga ritariryo",Toast.LENGTH_LONG).show();
		...
		public void decode(String json)
		{
			...
			SharedPreferences.Editor editor=shared.edit();
				...
				new AlertDialog.Builder(context)
					.setTitle("Kwinjira")
					.setMessage("Murakoze kwinjira Account yanyu kuri Trumpet, mushobora kwandikisha ibyangombwa cg imitungo yabuze tukabafasha kuyibona,muhitemo!")
