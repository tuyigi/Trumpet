...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		if(language.equals("Kinyarwanda")) {
			...
			finish();
			Intent intent =new Intent(getApplicationContext(),com.itdevsltd.searcher.english.MainActivity.class);
	...
	natoye.setOnClickListener(new View.OnClickListener() {
			...
			if(check.equals("yes"))
			{
				...
				if(language.equals("Kinyarwanda")) {
					...
					Intent in=new Intent(getApplicationContext(),com.itdevsltd.searcher.english.natoye.class);
					startActivity(in);
					MainActivity.this.overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
				}else{
					Intent in=new Intent(getApplicationContext(),natoye.class);
			...
			else
			{
				if(language.equals("Kinyarwanda")) {
					...
					finish();
					Intent intent =new Intent(getApplicationContext(),com.itdevsltd.searcher.english.register.class);
					startActivity(intent);
		...
		nataye.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					...
					{ if(language.equals("English")) {
						Intent in = new Intent(getApplicationContext(), com.itdevsltd.searcher.english.nataye.class);
						startActivity(in);
						MainActivity.this.overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
					}else if(language.equals("Kinyarwanda")) {
					 ...
					 getData getValue=getdata1.get(position);
					  String type=getValue.getType();					
				        String tit=getValue.getTitle();					
						 ...
						 builder.setTitle("Birakenewe");
						 builder.setMessage("Iki gikoresho cyaba ari icyawe cyangwa waragitoraguye? mushyiremo nimero ikiranga yose kugirango tubashe kubimenya!");
						 
						 final EditText input = new EditText(MainActivity.this);
// Specify the type of input expected; this, for example, sets the input as a password, and will mask the text
						 input.setInputType(InputType.TYPE_CLASS_TEXT);
						 input.setHint("nimero y'igikoresho");
						 builder.setView(input);

// Set up the buttons
						 builder.setPositiveButton("Komeza", new DialogInterface.OnClickListener() { 
								 @Override
								 public void onClick(DialogInterface dialog, int which) {
									 ...
									 if(text.trim().equals(fullserial))
									 {
										 if(language.equals("Kinyarwanda")) {
											 ...
											 Intent in = new Intent(MainActivity.this, com.itdevsltd.searcher.english.HomeActivity.class);
											 in.putExtras(bundle);
											 startActivity(in);
											 MainActivity.this.overridePendingTransition(android.R.anim.slide_in_left, android.R.anim.slide_out_right);
										 }else{
									 ...
									 {
										 Toast.makeText(MainActivity.this,"Winjije nimero idahuye n'iyigikoresho!",Toast.LENGTH_LONG).show();
								
										 }
								 }
							 });
						 builder.setNegativeButton("Bireke", new DialogInterface.OnClickListener() {
								 @Override
								 public void onClick(DialogInterface dialog, int which) {
									 dialog.cancel();
								 }
	...
	checkbtn.setOnClickListener(new View.OnClickListener()
	{
		...
		public void onClick(View v)
		{
			...
			{
				layout_serial.setError("Mushyiremo nimero");
				
			}
			else if(!(input_serial.getText().toString().trim().equals(fullserial.trim())))
			{
				layout_serial.setError("Nimero mwanditse ntihura");
				
			}
			else
			{
				rl.setVisibility(View.VISIBLE);
				seriall.setText("Nimero ikiranga: "+fullserial);
...
//////////////////////////////////////////////////////////
	...
	{
		getdata1.clear();
		loading.setText("Ikibazo mugushakisha");
	...
	else if(result.equals("no document found"))
	{
		...
		getdata1.clear();
		loading.setText("Ntikiboneka");
		recyclerViewadapter.notifyDataSetChanged();
		
	}
	else
	{
		loading.setText("Ibyo mwashatse:");
		decoder(result);
        ...
        public void afterTextChanged(Editable editable) {
			...
			loader.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR,editable.toString());
			 ...
			 else
			 {
				 ...
				 getdata1.clear();
				 loading.setText("Mubanze mwiyandikishe!");
