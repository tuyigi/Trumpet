...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder Viewholder, int position) {
		...
		Viewholder.serial.setText("Nimero ikiranga :"+serial);
		
		String stat=null;
		String owner=getData1.getOwner();
		if(getData1.getStatus().equals("lost"))
		{
			owner="Uwagitaye: "+owner;
			stat="<font color='red'>Cyarabuze</font>";
		}
		else
		{
			owner="Uwagitoye: "+owner;
			
			stat="<font color='green'>Cyaratowe</font>";
