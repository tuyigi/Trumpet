...
public class nataye extends AppCompatActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.nataye);
...
title.setText("Register lost tool");
		...
		layout_desc.setHint("Lost place address");
	...
	public void validate()
	{
		...
		{
			layout_doc.setError("Enter name of equipment");
		...
		{
			layout_desc.setError("Enter lost place");
			layout_sel.setError(null);
			layout_doc.setError(null);
		...
		{
			send send=new send();
			send.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR,doc.getText().toString(),sel.getText().toString(),names,phone,address,desc.getText().toString(),"none","lost");
...
//////////////////////////////////////////////////////////
	...
	private class send extends AsyncTask<String, String, String>
	{
		...
		protected void onPreExecute()
		{
			...
			progress=ProgressDialog.show(nataye.this,"","Sending...",false,true);
			// TODO: Implement this method
			super.onPreExecute();
		}
		...
		protected void onPostExecute(String result) {
			...
			{
				Toast.makeText(getApplicationContext(),"Thank you for your report, if it is found you will be notified!",Toast.LENGTH_LONG).show();
				sel.setText("");
				desc.setText("");
				doc.setText("");
			}
			...
			{
				Toast.makeText(getApplicationContext(),"Someone has found it, you can talk with him",Toast.LENGTH_LONG).show();
				sel.setText("");
				desc.setText("");
				doc.setText("");
				decoder(result);
	...
	public void decoder(String json)
	{
		...
		try
		{
			...
			new AlertDialog.Builder(nataye.this)
				.setTitle("Something found")
				.setMessage("Someone has found  "+tit+" number "+ser+"we can connect with him")
				.setPositiveButton("More", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialogInterface, int i) {
						...
						Intent in=new Intent(nataye.this,HomeActivity.class);
						in.putExtras(bundle);
						startActivity(in);
						nataye.this.overridePendingTransition(android.R.anim.slide_in_left,android.R.anim.slide_out_right);
